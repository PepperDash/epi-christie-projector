...
{
	/// <summary>
	/// Controller for Christie 4K35 RGB projector providing two-way communication,
	/// input routing, power management, and video mute functionality
	/// </summary>
	public class Christie4K35RgbController : TwoWayDisplayBase, ICommunicationMonitor,
		IBridgeAdvanced, IHasInputs<string>, IRoutingSinkWithSwitchingWithInputPort
	{
		...
		/// <summary>
		/// Initializes a new instance of the Christie4K35RgbController class
		/// </summary>
		...
		public Christie4K35RgbController(string key, string name, ChristieProjectorPropertiesConfig config, IBasicCommunication comms)
			: base(key, name)
		{
			var props = config;
			if (props == null)
		...
		private void InitializeInputs()
		{
			...
			new RoutingInputPort(RoutingPortNames.HdmiIn3, eRoutingSignalType.Audio | eRoutingSignalType.Video,
					eRoutingPortConnectionType.Hdmi, new Action(InputVomHdmi1), this), 3);
			...
			AddRoutingInputPort(
				new RoutingInputPort(RoutingPortNames.SdiIn, eRoutingSignalType.Audio | eRoutingSignalType.Video,
					eRoutingPortConnectionType.Sdi, new Action(InputSdi1), this), 8);
		...
		/// <summary>
		/// Selects VOM HDMI input 1 on the projector
		/// </summary>
		...
		/// <summary>
		/// Selects VOM DisplayPort input 1 on the projector
		/// </summary>
		...
		/// <summary>
		/// Selects VOM DisplayPort input 2 on the projector
		/// </summary>
		...
		public void UpdateInputFb(int input)
		{
			...
			switch (CurrentInputPort.Key)
			{
				...
				case RoutingPortNames.VgaIn1:
					CurrentInputNumber = 12;
					break;
				case RoutingPortNames.VgaIn:
					CurrentInputNumber = 13;
					break;
			}
		}
